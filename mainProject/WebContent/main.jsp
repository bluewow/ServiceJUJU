            ...
            <div class="card">
               <div class="card-block">
                  <section class="capture">
                     ...
                     <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="capture"
                           role="tabpanel" aria-labelledby="capture-tab">
                           <iframe height="100%" src="./card/capturememo/captureMemo"
...
=======
>>>>>>> cc2231c3ded2a04a67db6292080543394030fc8c
	<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"
		integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN"
		crossorigin="anonymous"></script>
	<script
	...
	<script
		...
		integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl"
		crossorigin="anonymous"></script>
>>>>>>> branch 'master' of https://github.com/bluewow/ServiceJUJU.git
</body>
