...
import com.stockmarket.www.dao.KospiDao;
import com.stockmarket.www.entity.Kospi;

public class JdbcKospiDao implements KospiDao {

	@Override
	public List<Kospi> getList() {
		
		return null;
	}

	@Override
	public int insert(List<Kospi> list) {
		int result = 0;
		
		String sql = "INSERT INTO KOSPI (COMPANYNAME, STOCKCODE, SECTORS, MAINPRODUCT, STOCKEDDAY, SETTLEMENTMONTH, REPRESENTATIVENAME, WEBSITE, LOCATION) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
